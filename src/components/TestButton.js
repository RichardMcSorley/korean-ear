...
import FlatButtonLabel from 'material-ui/FlatButton/FlatButtonLabel';
...
class FlatButton extends Component {
  ...
  handleMouseEnter = (event) => {
    ...
    if(!this.state.disabled){
      if (!this.state.touch) this.setState({hovered: true, disabled: true});
      this.props.onMouseEnter(event, setTimeout(()=>{
              this.setState({hovered: false, disabled: false});
            }, 500));
